          ...
          <div className="flex flex-col sm:flex-row sm:items-center gap-3 mb-6">
            <div className="flex items-center gap-2">
              <select
                ...
                className="border border-gray-300 px-3 py-2 sm:px-4 sm:py-1"
              >
            ...
            <div className="flex items-center justify-center gap-2 flex-wrap w-full sm:w-auto">
              <button
                ...
                className="w-[28px] h-[28px] flex items-center justify-center disabled:opacity-40"
              ...
              {[...Array(totalPages)].map((_, i) => {
                ...
                return (
                  <button
                    key={n}
                    onClick={() => setPage(n)}
                    className={`w-[28px] h-[28px] flex items-center justify-center font-inter font-bold text-[16px] ${page === n
